...
function handleResult(_ref) {
  ...
  console.log('This is a valid color'); // change the background color
...
var colorEl = document.querySelector('.colors'); //display the colors on the page
...
window.SpeechRecognition = window.SpeechRecognition || window.webkitSpeechRecognition; //the main function 
